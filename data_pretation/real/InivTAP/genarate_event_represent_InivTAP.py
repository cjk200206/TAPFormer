...
from read_aedat4_2_dataset import blosc_opts

def generate_time_surface_single(
    input_seq_dir, output_dir, visualize=False, n_bins=5, dt=0.01, center_time=False, **kwargs
):
    """
...
if __name__ == "__main__":
    ...
    for dataset_name, dt in EVAL_DATASETS_Aedat4:
        ...
        elif representation_type == "time_surface_acuumulate":
            generate_time_surface_accumulate(input_folder, output_dir=input_folder, visualize=False, n_bins=5, dt=dt)
